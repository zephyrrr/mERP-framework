...
namespace Feng.Windows.TaskScheduler
{
	#region Enums
	/// <summary>
	...
	public abstract class Trigger : ICloneable {
		...
		public bool HasEndDate {
			...
			set {
				if (value)
					throw new ArgumentException("HasEndDate can only be set false", "value");
	...
	public abstract class StartableTrigger : Trigger {
        ...
        protected void SetStartTime(short hour, short minute)
        {
//			if (hour < 0 || hour > 23)
...
//			base.SyncTrigger();
	...
	public class RunOnceTrigger : StartableTrigger {
		...
		public RunOnceTrigger(DateTime runDateTime) : base() {
            ...
            SetStartTime((short)runDateTime.Hour, (short)runDateTime.Minute);
