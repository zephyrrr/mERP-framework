...
namespace Feng.Windows.Forms
{
    ...
    public class Wizard : System.Windows.Forms.UserControl
    {
            ...
            set
            {
                ...
                if (value < -1 || value >= this.pages.Count)
                {
                    throw new ArgumentOutOfRangeException("SelectedIndex",
                                                          ...
                                                          Convert.ToString(this.pages.Count - 1));
                }
        ...
        {
            get { return this.buttonBack.Enabled; }
            set { this.buttonBack.Enabled = value; }
        }
        ...
        {
            get { return this.buttonHelp.Visible; }
            set { this.buttonHelp.Visible = value; }
        }
        ...
        {
            get { return this.buttonBack.Text; }
            set { this.buttonBack.Text = value; }
        }
        ...
        {
            get { return this.buttonCancel.Text; }
            set { this.buttonCancel.Text = value; }
        }
        ...
        {
            get { return this.buttonHelp.Text; }
            set { this.buttonHelp.Text = value; }
        }
        ...
        public class AfterSwitchPagesEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Creates a new instance of the <see cref="AfterSwitchPagesEventArgs"/> class.
            /// </summary>
        ...
        public class BeforeSwitchPagesEventArgs : AfterSwitchPagesEventArgs
        {
            ...
            /// <summary>
            /// Creates a new instance of the <see cref="BeforeSwitchPagesEventArgs"/> class.
            /// </summary>
            /// <param name="oldIndex">An integer value representing the index of the old page.</param>
            /// <param name="newIndex">An integer value representing the index of the new page.</param>
            ...
            {
                get { return base.m_newIndex; }
                set { base.m_newIndex = value; }
            }
