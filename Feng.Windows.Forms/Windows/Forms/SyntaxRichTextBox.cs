...
namespace SyntaxHighlighter
{
    ...
    public class SyntaxRichTextBox : System.Windows.Forms.RichTextBox
    {
        ...
        private Dictionary<string, Regex> m_regexDict = new Dictionary<string, Regex>();
        /// <summary>
        ...
        {
            if (!m_regexDict.ContainsKey(strRegex))
            {
                m_regexDict[strRegex] = new Regex(strRegex, RegexOptions.IgnoreCase | RegexOptions.Compiled);
            }
            Regex regKeywords = m_regexDict[strRegex];
            Match regMatch;
