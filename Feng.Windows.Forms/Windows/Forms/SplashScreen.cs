...
namespace Feng.Windows.Forms
{
    ...
    /// SplashScreen
    /// </summary>
    public sealed class SplashScreen : System.Windows.Forms.Control
    {
            ...
            if (Bounds.Width > 0 && Bounds.Height > 0 && Visible)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    Console.WriteLine("\nException: {0}, \n\t{1}, \n\t{2}, \n\t{3}\n", this.GetType().ToString(),
                                      stackFrame.GetMethod().ToString(), stackFrame.GetFileLineNumber(),
                                      exception.Message);
                }
            }
        }
        ...
        public void BeginDisplay()
        {
            ...
            SetWindowPos(this.Handle, (System.IntPtr)HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE);
            this.Refresh();
        }
        ...
        public void SetCommentaryString(string commentary)
        {
            this.CommentaryString = commentary;
        }
        ...
        {
            get { return m_strCommentaryString; }
            set
            {
