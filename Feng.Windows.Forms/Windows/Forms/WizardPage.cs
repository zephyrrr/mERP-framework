        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (this.style)
            {
                case WizardPageStyle.Standard:
                    ...
                    int headerTitleHeight =
                        (int) Math.Ceiling(e.Graphics.MeasureString(this.title, headerTitleFont, 0, textFormat).Height);
                ...
                case WizardPageStyle.Finish:
                    ...
                    // determine title height
                    int welcomeTitleHeight =
                        (int)
                        Math.Ceiling(
                            e.Graphics.MeasureString(this.title, welcomeTitleFont, titleRect.Width, textFormat).Height);
                    descriptionRect.Location = titleRect.Location;
